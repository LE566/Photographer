        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-5 footer-col opacity-0">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://instagram.com/magal_lens" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white hover:text-black transition-all duration-300">
