      ...
      if(columns) {
        gsap.fromTo(columns, 
          { y: 50, opacity: 0 },
          {
            ...
            opacity: 1,
            duration: 0.8,
            stagger: 0.1, // Efecto cascada entre columnas
            ease: "power3.out",
            scrollTrigger: {
              trigger: footerRef.current,
              start: "top 90%", // Empieza cuando el footer asoma
            }
          }
        );
      }
    ...
    <footer ref={footerRef} className="bg-[#050505] text-white pt-20 pb-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          {/* COLUMNA 1: Marca y Bio (Ocupa 5 columnas en desktop) */}
          ...
          {/* COLUMNA 2: Navegación (2 columnas en desktop) */}
          ...
          {/* COLUMNA 3: Servicios (3 columnas en desktop) */}
          ...
          {/* COLUMNA 4: Botón Subir (2 columnas) */}
        ...
        <div className="footer-bottom opacity-0 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          <p>&copy; {currentYear} Gus Velasco Photography. Todos los derechos reservados.</p>
